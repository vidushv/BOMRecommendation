...
public class SupportVectorMachineRecommendor implements Recommendor{
	
	Logger logger = LoggerFactory.getLogger(SupportVectorMachineRecommendor.class);
	...
	public List<STPO> getRecommendations(STPO stpoFromUI, CDPOSService cdposService) throws IOException, InterruptedException {
		...
		ProcessBuilder builder = new ProcessBuilder("sh",
				"/home/mukul/git/BOMRecommendation/machine_learning/execute.sh", "/home/mukul/git/BOMRecommendation/machine_learning/csvfile.csv", RecommendationFactory.SUPPORT_VECTOR_MACHINE);
