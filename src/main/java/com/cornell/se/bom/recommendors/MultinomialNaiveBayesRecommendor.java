...
public class MultinomialNaiveBayesRecommendor implements Recommendor{
	
	Logger logger = LoggerFactory.getLogger(MultinomialNaiveBayesRecommendor.class);
	...
	public List<STPO> getRecommendations(STPO stpoFromUI, CDPOSService cdposService) throws IOException, InterruptedException {
		...
		ProcessBuilder builder = new ProcessBuilder("sh",
				"/home/mukul/git/BOMRecommendation/machine_learning/execute.sh", "/home/mukul/git/BOMRecommendation/machine_learning/csvfile.csv", RecommendationFactory.MULTINOMIAL_NAIVE_BAYES);
